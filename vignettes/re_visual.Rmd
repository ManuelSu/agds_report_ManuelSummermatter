...
## Temporal pattern of wind speed
...
This visualization shows that the average of the wind speed (subtracting the fluctuations) declines mid-June and stays lower until mid-September, when it starts to increase again.
...
summary(model)
```
The coefficient of Solar radiation is 0.12717. This means that if Solar radiation increased by 1 Langley, Ozone increases by 0.12717 parts per billion. This effect is statistically significant on the 1% level, as the respective p value is 0.000179 which is smaller than 0.01 