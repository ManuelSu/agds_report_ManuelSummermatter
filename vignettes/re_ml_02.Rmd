...
eval_model_chapter_10(mod = mod_knn_Davos, df_train = fluxes_Laegern_train, df_test = fluxes_Davos_test)

# KNN prediction for Laegern, across-site
eval_model_chapter_10(mod = mod_knn_Laegern, df_train = fluxes_Davos_train, df_test = fluxes_Laegern_test)
```
